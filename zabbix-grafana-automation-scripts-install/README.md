...
O arquivo install-zabbix-grafana.ufw-linux.sh é uma versão personalizada por mim. A principal melhoria foi a implementação do Hardening de Firewall (UFW).
